...
function PCComponent() {
  ...
  return (
    <div ref={containerRef} className="h-full p-40">
      <motion.h1
      ...
      <div className="mt-20 flex items-center justify-center gap-12">
        <div className="group transition-all duration-300">
          <div className="overflow-hidden rounded-2xl border-4 border-[#FF7667] shadow-lg shadow-[#FF766770] transition-transform duration-300 hover:scale-105">
            <video autoPlay loop muted playsInline className="w-full max-w-xl">
              <source src="/videos/home/planit.mp4" />
            </video>
          </div>
          <p className="mt-4 text-center text-gray-300">팀 일정 관리 서비스</p>
        </div>
